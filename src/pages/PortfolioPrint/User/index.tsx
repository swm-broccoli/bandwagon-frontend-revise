...
function UserPortfolioPrint({ portfolio }: { portfolio: UserProfileType }) {
  useEffect(() => {
    ...
    <main className='flex flex-col items-start'>
      ...
      <div className='avatar'>
        <div className='w-40 rounded-full border border-base-300'>
          <img
            src={portfolio.avatarUrl ? portfolio.avatarUrl : DefaultUserImg}
...
function UserPortFolioPrintPage() {
  ...
  return (
    ...
    >
      <UserPortfolioPrint portfolio={portfolio} />
    </div>
  );
}

export default UserPortFolioPrintPage;
