      ...
      <div className='flex flex-col w-full pt-8'>
        {showList ? (
          ...
          <button
            ...
            className='btn btn-primary btn-sm self-end h-2 mr-[5%] mb-2 md:hidden'
          >
            목록
          </button>
        )}
        <div className='flex w-[90%] md:w-2/3 h-[70vh] self-center justify-items-center'>
          <div
            className={
              showList
                ...
                : 'hidden md:flex flex-col w-full md:w-80 '
            }
          >
            {channels.map((channel, index) => {
              return (
                <div
                  key={index}
                  className='w-full h-20 border-[#e9e9e9] border '
                >
                  <ChannelPreview
                    channel={channel}
          ...
          >
            <div
              className={
                showList
                  ? 'w-full md:w-full hidden md:flex'
                  : 'w-full md:w-full'
              }
            >
              <Channel
